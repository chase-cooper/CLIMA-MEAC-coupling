...
#define TPLIST                 "scenario_library/test/TP.dat"
...
#define SPECIES_LIST "scenario_library/test/species_scenario_N2r.dat"
...
#define IMPORTFILEX "scenario_library/test/Conx.dat" /* File of concentrations X to be imported */
#define IMPORTFILEF "scenario_library/test/Conf.dat" /* File of concentrations F to be imported */       
...
#define KET1 1.0E+6
#define KEH1 1.0E+8
#define EDDYIMPORT	"scenario_library/test/Eddy.dat"
...
/* Output Options */
#define OUT_FILE1			"scenario_library/test/Conx.dat"
#define OUT_FILE2			"scenario_library/test/Conf.dat"
#define OUT_HISTORY			"scenario_library/test/History.dat"
#define OUT_PHOTORATE		"scenario_library/test/Photorate.dat"
#define OUT_CHEMICALRATE	"scenario_library/test/ChemicalRate.dat"
#define OUT_CONVERGENCE		"scenario_library/test/Convergence.dat"
#define OUT_TIMESCALE		"scenario_library/test/Timescale.dat"
#define OUT_COLUMN			"scenario_library/test/ColumnDensity.dat"
#define OUT_STD				"scenario_library/test/ConcentrationSTD.dat"
#define OUT_BALANCE			"scenario_library/test/GlobalBalance.dat"
#define OUT_RADIATION		"scenario_library/test/Radiation.dat"
#define OUT_MEANOPAC		"scenario_library/test/MeanOpacity.dat"
#define OUT_NEWTEMP			"scenario_library/test/NewTemperature.dat"
...
#define UVRFILE			"scenario_library/test/Reflection.dat"  /* Output spectrum file name */
#define UVRFILEVar1		"scenario_library/test/ReflectionVar1.dat"  /* Output spectrum file name */
#define UVRFILEVar2		"scenario_library/test/ReflectionVar2.dat"  /* Output spectrum file name */
#define UVRFILEVar3		"scenario_library/test/ReflectionVar3.dat"  /* Output spectrum file name */
#define UVRFILEVar4		"scenario_library/test/ReflectionVar4.dat"  /* Output spectrum file name */
#define UVROPTFILE		"scenario_library/test/UVROpt.dat" /* Output spectrum file name*/

/* Stellar Light Transmission output options */
#define UVTFILE			"scenario_library/test/Transmission.dat" /* Output spectrum file name */
#define UVTFILEVar1		"scenario_library/test/TransmissionVar1.dat" /* Output spectrum file name */
#define UVTFILEVar2		"scenario_library/test/TransmissionVar2.dat" /* Output spectrum file name */
#define UVTFILEVar3		"scenario_library/test/TransmissionVar3.dat" /* Output spectrum file name */
#define UVTFILEVar4		"scenario_library/test/TransmissionVar4.dat" /* Output spectrum file name */
#define UVTOPTFILE		"scenario_library/test/UVTOpt.dat" /* Output spectrum file name*/

/* Thermal Emission output options */
#define IRFILE			"scenario_library/test/Emission.dat"	     /* Output spectrum file name */
#define IRFILEVar1		"scenario_library/test/EmissionVar1.dat"	 /* Output spectrum file name */
#define IRFILEVar2		"scenario_library/test/EmissionVar2.dat"	 /* Output spectrum file name */
#define IRFILEVar3		"scenario_library/test/EmissionVar3.dat"	 /* Output spectrum file name */
#define IRFILEVar4		"scenario_library/test/EmissionVar4.dat"	 /* Output spectrum file name */
#define IRCLOUDFILE		"scenario_library/test/CloudTopE.dat"      /* Output emission cloud top file name */

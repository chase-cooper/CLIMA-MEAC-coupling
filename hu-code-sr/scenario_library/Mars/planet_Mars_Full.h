...
#define MASS_PLANET           6.4185E+23  /* kg */ /* Mars */
#define RADIUS_PLANET         3389500.0   /* m */ /* Mars */

/* Planet Orbital Properties */
#define ORBIT               1.524          /* AU */ /* Mars */
#define STAR_SPEC           "Data/solar.txt"
...
#define zmax 120.0 /*Maximum altitude in km*/
...
#define SPECIES_LIST "scenario_library/Mars/species_Mars_Full.dat"
#define AIRM 43.2 /*Average molecular mass of atmosphere, in atomic mass unit*/
...
#define SATURATIONREDUCTION	0.6 /* Ad hoc reduction factor for saturation pressure of water */
...
#define IMPORTFILEX "Data/Conx_Mars_Full_1.dat" /* File of concentrations X to be imported */
#define IMPORTFILEF "Data/Conf_Mars_Full_1.dat" /* File of concentrations F to be imported */       
...
/* Reaction Zones */
#define REACTION_LIST "Data/zone_Mars_Full.dat"
...
#define	RainF	0.01	/* Rainout factor, 0 for no rainout, 1 for earthlike normal rainout, <1 for reduced rainout */
#define	CloudDen	1.0	/* Cloud density in the unit of g m-3 */
#define AbioticRainout  0 /*If 1: Rainout of H2, CO, CH4, NH3, N2, C2H2, C2H4, C2H6, and O2 turned off under assumption of saturation on abiotic planets (Hu et al. 2012 following Kasting). If 0: all gases rain out as normal (c.f. Earth).*/

/* Output Options */
#define OUT_FILE1  			"scenario_library/Mars/Conx.dat"
#define OUT_FILE2  			"scenario_library/Mars/Conf.dat"
#define OUT_HISTORY			"scenario_library/Mars/History.dat"
#define OUT_PHOTORATE		"scenario_library/Mars/Photorate.dat"
#define OUT_CHEMICALRATE	"scenario_library/Mars/ChemicalRate.dat"
#define OUT_CONVERGENCE		"scenario_library/Mars/Convergence.dat"
#define OUT_TIMESCALE		"scenario_library/Mars/Timescale.dat"
#define OUT_COLUMN			"scenario_library/Mars/ColumnDensity.dat"
#define OUT_STD				"scenario_library/Mars/ConcentrationSTD.dat"
#define OUT_BALANCE			"scenario_library/Mars/GlobalBalance.dat"
#define OUT_RADIATION		"scenario_library/Mars/Radiation.dat"
#define OUT_MEANOPAC		"scenario_library/Mars/MeanOpacity.dat"
#define OUT_NEWTEMP			"scenario_library/Mars/NewTemperature.dat"
...
#define UVRFILE			"Illustration/Reflection.dat"  /* Output spectrum file name */
#define UVRFILEVar1		"Illustration/ReflectionVar1.dat"  /* Output spectrum file name */
#define UVRFILEVar2		"Illustration/ReflectionVar2.dat"  /* Output spectrum file name */

/* Stellar Light Transmission output options */
#define UVTFILE			"Illustration/Transmission.dat" /* Output spectrum file name */
#define UVTFILEVar1		"Illustration/TransmissionVar1.dat" /* Output spectrum file name */
#define UVTFILEVar2		"Illustration/TransmissionVar2.dat" /* Output spectrum file name */

/* Thermal Emission output options */
#define IRFILE			"Illustration/Emission.dat"	     /* Output spectrum file name */
#define IRFILEVar1		"Illustration/EmissionVar1.dat"	 /* Output spectrum file name */
#define IRFILEVar2		"Illustration/EmissionVar2.dat"	 /* Output spectrum file name */

...
#define SPECIES_LIST "scenario_library/scenario_CO2r_NoE/species_scenario_CO2N2r_NoE.dat"
...
#define IMPORTFILEX "scenario_library/scenario_CO2r_NoE/Conx.dat" /* File of concentrations X to be imported */
#define IMPORTFILEF "scenario_library/scenario_CO2r_NoE/Conf.dat" /* File of concentrations F to be imported */       
...
/* Output Options */
#define OUT_FILE1			"scenario_library/scenario_CO2r_NoE/Conx.dat"
#define OUT_FILE2			"scenario_library/scenario_CO2r_NoE/Conf.dat"
#define OUT_HISTORY			"scenario_library/scenario_CO2r_NoE/History.dat"
#define OUT_PHOTORATE		"scenario_library/scenario_CO2r_NoE/Photorate.dat"
#define OUT_CHEMICALRATE	"scenario_library/scenario_CO2r_NoE/ChemicalRate.dat"
#define OUT_CONVERGENCE		"scenario_library/scenario_CO2r_NoE/Convergence.dat"
#define OUT_TIMESCALE		"scenario_library/scenario_CO2r_NoE/Timescale.dat"
#define OUT_COLUMN			"scenario_library/scenario_CO2r_NoE/ColumnDensity.dat"
#define OUT_STD				"scenario_library/scenario_CO2r_NoE/ConcentrationSTD.dat"
#define OUT_BALANCE			"scenario_library/scenario_CO2r_NoE/GlobalBalance.dat"
#define OUT_RADIATION		"scenario_library/scenario_CO2r_NoE/Radiation.dat"
#define OUT_MEANOPAC		"scenario_library/scenario_CO2r_NoE/MeanOpacity.dat"
#define OUT_NEWTEMP			"scenario_library/scenario_CO2r_NoE/NewTemperature.dat"
...
#define	Var2RATIO		100.0
#define Var3RATIO		100.0
#define	Var4RATIO		0.0

/*  Stellar Light Reflection output options */
#define UVRFILE			"scenario_library/scenario_CO2r_NoE/Reflection.dat"  /* Output spectrum file name */
#define UVRFILEVar1		"scenario_library/scenario_CO2r_NoE/ReflectionVar1.dat"  /* Output spectrum file name */
#define UVRFILEVar2		"scenario_library/scenario_CO2r_NoE/ReflectionVar2.dat"  /* Output spectrum file name */
#define UVRFILEVar3		"scenario_library/scenario_CO2r_NoE/ReflectionVar3.dat"  /* Output spectrum file name */
#define UVRFILEVar4		"scenario_library/scenario_CO2r_NoE/ReflectionVar4.dat"  /* Output spectrum file name */
#define UVROPTFILE		"scenario_library/scenario_CO2r_NoE/UVROpt.dat" /* Output spectrum file name*/

/* Stellar Light Transmission output options */
#define UVTFILE			"scenario_library/scenario_CO2r_NoE/Transmission.dat" /* Output spectrum file name */
#define UVTFILEVar1		"scenario_library/scenario_CO2r_NoE/TransmissionVar1.dat" /* Output spectrum file name */
#define UVTFILEVar2		"scenario_library/scenario_CO2r_NoE/TransmissionVar2.dat" /* Output spectrum file name */
#define UVTFILEVar3		"scenario_library/scenario_CO2r_NoE/TransmissionVar3.dat" /* Output spectrum file name */
#define UVTFILEVar4		"scenario_library/scenario_CO2r_NoE/TransmissionVar4.dat" /* Output spectrum file name */
#define UVTOPTFILE		"scenario_library/scenario_CO2r_NoE/UVTOpt.dat" /* Output spectrum file name*/

/* Thermal Emission output options */
#define IRFILE			"scenario_library/scenario_CO2r_NoE/Emission.dat"	     /* Output spectrum file name */
#define IRFILEVar1		"scenario_library/scenario_CO2r_NoE/EmissionVar1.dat"	 /* Output spectrum file name */
#define IRFILEVar2		"scenario_library/scenario_CO2r_NoE/EmissionVar2.dat"	 /* Output spectrum file name */
#define IRFILEVar3		"scenario_library/scenario_CO2r_NoE/EmissionVar3.dat"	 /* Output spectrum file name */
#define IRFILEVar4		"scenario_library/scenario_CO2r_NoE/EmissionVar4.dat"	 /* Output spectrum file name */
#define IRCLOUDFILE		"scenario_library/scenario_CO2r_NoE/CloudTopE.dat"      /* Output emission cloud top file name */

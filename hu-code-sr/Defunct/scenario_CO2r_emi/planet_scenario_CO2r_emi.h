...
#define SPECIES_LIST "./scenario_library/scenario_CO2r_emi/species_scenario_CO2N2r_emi.dat"
...
#define IMPORTFILEX "scenario_library/scenario_CO2r_emi/Conx.dat" /* File of concentrations X to be imported */
#define IMPORTFILEF "scenario_library/scenario_CO2r_emi/Conf.dat" /* File of concentrations F to be imported */       
...
/* Output Options */
#define OUT_FILE1			"scenario_library/scenario_CO2r_emi/Conx.dat"
#define OUT_FILE2			"scenario_library/scenario_CO2r_emi/Conf.dat"
#define OUT_HISTORY			"scenario_library/scenario_CO2r_emi/History.dat"
#define OUT_PHOTORATE		"scenario_library/scenario_CO2r_emi/Photorate.dat"
#define OUT_CHEMICALRATE	"scenario_library/scenario_CO2r_emi/ChemicalRate.dat"
#define OUT_CONVERGENCE		"scenario_library/scenario_CO2r_emi/Convergence.dat"
#define OUT_TIMESCALE		"scenario_library/scenario_CO2r_emi/Timescale.dat"
#define OUT_COLUMN			"scenario_library/scenario_CO2r_emi/ColumnDensity.dat"
#define OUT_STD				"scenario_library/scenario_CO2r_emi/ConcentrationSTD.dat"
#define OUT_BALANCE			"scenario_library/scenario_CO2r_emi/GlobalBalance.dat"
#define OUT_RADIATION		"scenario_library/scenario_CO2r_emi/Radiation.dat"
#define OUT_MEANOPAC		"scenario_library/scenario_CO2r_emi/MeanOpacity.dat"
#define OUT_NEWTEMP			"scenario_library/scenario_CO2r_emi/NewTemperature.dat"
...
#define UVRFILE			"scenario_library/scenario_CO2r_emi/Reflection.dat"  /* Output spectrum file name */
#define UVRFILEVar1		"scenario_library/scenario_CO2r_emi/ReflectionVar1.dat"  /* Output spectrum file name */
#define UVRFILEVar2		"scenario_library/scenario_CO2r_emi/ReflectionVar2.dat"  /* Output spectrum file name */
#define UVRFILEVar3		"scenario_library/scenario_CO2r_emi/ReflectionVar3.dat"  /* Output spectrum file name */
#define UVRFILEVar4		"scenario_library/scenario_CO2r_emi/ReflectionVar4.dat"  /* Output spectrum file name */
#define UVROPTFILE		"scenario_library/scenario_CO2r_emi/UVROpt.dat" /* Output spectrum file name*/

/* Stellar Light Transmission output options */
#define UVTFILE			"scenario_library/scenario_CO2r_emi/Transmission.dat" /* Output spectrum file name */
#define UVTFILEVar1		"scenario_library/scenario_CO2r_emi/TransmissionVar1.dat" /* Output spectrum file name */
#define UVTFILEVar2		"scenario_library/scenario_CO2r_emi/TransmissionVar2.dat" /* Output spectrum file name */
#define UVTFILEVar3		"scenario_library/scenario_CO2r_emi/TransmissionVar3.dat" /* Output spectrum file name */
#define UVTFILEVar4		"scenario_library/scenario_CO2r_emi/TransmissionVar4.dat" /* Output spectrum file name */
#define UVTOPTFILE		"scenario_library/scenario_CO2r_emi/UVTOpt.dat" /* Output spectrum file name*/

/* Thermal Emission output options */
#define IRFILE			"scenario_library/scenario_CO2r_emi/Emission.dat"	     /* Output spectrum file name */
#define IRFILEVar1		"scenario_library/scenario_CO2r_emi/EmissionVar1.dat"	 /* Output spectrum file name */
#define IRFILEVar2		"scenario_library/scenario_CO2r_emi/EmissionVar2.dat"	 /* Output spectrum file name */
#define IRFILEVar3		"scenario_library/scenario_CO2r_emi/EmissionVar3.dat"	 /* Output spectrum file name */
#define IRFILEVar4		"scenario_library/scenario_CO2r_emi/EmissionVar4.dat"	 /* Output spectrum file name */
#define IRCLOUDFILE		"scenario_library/scenario_CO2r_emi/CloudTopE.dat"      /* Output emission cloud top file name */

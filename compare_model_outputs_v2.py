...
def plot_comparison(base_file, new_file, name=None, saveas=None):
    """
    #Base file, with 0 PH3
    #New file, with nonzero PH3
...
##    ##CO2-vale
    ...
    plt.suptitle("Base --> solid line, updated --> dotted line",size='x-large')
    if saveas:
        plt.savefig(saveas+'.png', orientation='portrait', format='png', dpi=300)
    else:
        plt.show()
    plt.close()
...
# plot_comparison('hu-code-sr/scenario_library/Earth/ConcentrationSTD.dat', 'hu-code-sr/scenario_library/test1/ConcentrationSTD.dat', 'Earth')
...
# plot_comparison('hu-code-sr/scenario_library/test1/ConcentrationSTD.dat', 'hu-code-sr/scenario_library/test1/ConcentrationSTD_base_Earth.dat', 'Earth')

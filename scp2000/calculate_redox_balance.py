...
def redox_bal_func(GlobBalFile):
    ###########################
    ...
    ###########################
    globalbalance_table=np.genfromtxt(GlobBalFile, skip_header=1, skip_footer=0, names='Std_No, Outgassing, ChemProd, ChemLoss, DryDepo, WetDepo, Escape, Condensation, Net_Flux	, Global_Change', delimiter='\t') #genfromtxt does not like spaces or periods in column names. # ./GlobalBalance-NoE_fromRenyu.dat ##
...
###Step 4: Calculate atmosphere-ocean redox balance
###########################
redox_bal_func('./scenario_library/Sun/CO2-Full/GlobalBalance.dat')
redox_bal_func('./scenario_library/Sun/H2-Full/GlobalBalance.dat')
redox_bal_func('./scenario_library/Sun/N2-Full/GlobalBalance.dat')

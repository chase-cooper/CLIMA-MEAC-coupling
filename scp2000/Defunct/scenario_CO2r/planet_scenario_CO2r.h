...
#define SPECIES_LIST "scenario_library/scenario_CO2r/species_scenario_CO2N2r.dat"
...
#define IMPORTFILEX "scenario_library/scenario_CO2r/Conx.dat" /* File of concentrations X to be imported */
#define IMPORTFILEF "scenario_library/scenario_CO2r/Conf.dat" /* File of concentrations F to be imported */       
...
/* Output Options */
#define OUT_FILE1			"scenario_library/scenario_CO2r/Conx.dat"
#define OUT_FILE2			"scenario_library/scenario_CO2r/Conf.dat"
#define OUT_HISTORY			"scenario_library/scenario_CO2r/History.dat"
#define OUT_PHOTORATE		"scenario_library/scenario_CO2r/Photorate.dat"
#define OUT_CHEMICALRATE	"scenario_library/scenario_CO2r/ChemicalRate.dat"
#define OUT_CONVERGENCE		"scenario_library/scenario_CO2r/Convergence.dat"
#define OUT_TIMESCALE		"scenario_library/scenario_CO2r/Timescale.dat"
#define OUT_COLUMN			"scenario_library/scenario_CO2r/ColumnDensity.dat"
#define OUT_STD				"scenario_library/scenario_CO2r/ConcentrationSTD.dat"
#define OUT_BALANCE			"scenario_library/scenario_CO2r/GlobalBalance.dat"
#define OUT_RADIATION		"scenario_library/scenario_CO2r/Radiation.dat"
#define OUT_MEANOPAC		"scenario_library/scenario_CO2r/MeanOpacity.dat"
#define OUT_NEWTEMP			"scenario_library/scenario_CO2r/NewTemperature.dat"
...
#define UVRFILE			"scenario_library/scenario_CO2r/Reflection.dat"  /* Output spectrum file name */
#define UVRFILEVar1		"scenario_library/scenario_CO2r/ReflectionVar1.dat"  /* Output spectrum file name */
#define UVRFILEVar2		"scenario_library/scenario_CO2r/ReflectionVar2.dat"  /* Output spectrum file name */
#define UVRFILEVar3		"scenario_library/scenario_CO2r/ReflectionVar3.dat"  /* Output spectrum file name */
#define UVRFILEVar4		"scenario_library/scenario_CO2r/ReflectionVar4.dat"  /* Output spectrum file name */
#define UVROPTFILE		"scenario_library/scenario_CO2r/UVROpt.dat" /* Output spectrum file name*/

/* Stellar Light Transmission output options */
#define UVTFILE			"scenario_library/scenario_CO2r/Transmission.dat" /* Output spectrum file name */
#define UVTFILEVar1		"scenario_library/scenario_CO2r/TransmissionVar1.dat" /* Output spectrum file name */
#define UVTFILEVar2		"scenario_library/scenario_CO2r/TransmissionVar2.dat" /* Output spectrum file name */
#define UVTFILEVar3		"scenario_library/scenario_CO2r/TransmissionVar3.dat" /* Output spectrum file name */
#define UVTFILEVar4		"scenario_library/scenario_CO2r/TransmissionVar4.dat" /* Output spectrum file name */
#define UVTOPTFILE		"scenario_library/scenario_CO2r/UVTOpt.dat" /* Output spectrum file name*/

/* Thermal Emission output options */
#define IRFILE			"scenario_library/scenario_CO2r/Emission.dat"	     /* Output spectrum file name */
#define IRFILEVar1		"scenario_library/scenario_CO2r/EmissionVar1.dat"	 /* Output spectrum file name */
#define IRFILEVar2		"scenario_library/scenario_CO2r/EmissionVar2.dat"	 /* Output spectrum file name */
#define IRFILEVar3		"scenario_library/scenario_CO2r/EmissionVar3.dat"	 /* Output spectrum file name */
#define IRFILEVar4		"scenario_library/scenario_CO2r/EmissionVar4.dat"	 /* Output spectrum file name */
#define IRCLOUDFILE		"scenario_library/scenario_CO2r/CloudTopE.dat"      /* Output emission cloud top file name */
